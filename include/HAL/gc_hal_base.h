...
gcoOS_UpdateSimulatorCallback(
    INOUT VSIMULATOR_CALLBACK *Callback,
    IN gctBOOL update
    );

gceSTATUS gcoOS_SetFrameworkType(
    IN gctUINT32 frameworkType,
    IN gctINT32 cmSize
    );

void gcoOS_SetVSimulatorTarget(
    IN gctUINT32 hwConfigID,
    IN gctUINT32 skippedExecution
    );
#endif
...
#else
#   define gcmDUMP_FRAMERATE(...)   do {} while (0)
#endif
